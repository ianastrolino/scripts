    ...
    "categorias": [
        {
            ...
            "itens": [
                {"titulo": "Integração Omie (Indianópolis + São Miguel)",
                 ...
                 "nota":   "destrava 33% da rede — 2 unidades hoje sem sistema completo. OmieClient + roteador em api_send + tela de config."},
        ...
        },
        {
            ...
            "itens": [
                ...
                {"titulo": "Blueprints Flask por domínio",
                 "status": "pendente", "estimativa": "~2-3 dias",
                 "nota":   "server.py 8.7K → ~500 linhas. Caixa, Fechamento, Master, Auth viram blueprints. Refactor major mas blindado pelos 157 testes verdes."},
            ],
        },
        {
            "nome": "UX / Polimento",
        ...
        {
            "nome": "Concluídos — última semana (24-27/04)",
            "descricao": "Histórico do que foi entregue",
            "cor":  "#16a34a",
            "itens": [
                # 27/04 — segunda
