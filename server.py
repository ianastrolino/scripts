    ...
    "categorias": [
        ...
        },
        {
            ...
            "itens": [
                ...
                {"titulo": "Conferência antecipada — status em tempo real + vistoria órfã",
                 "status": "pendente", "estimativa": "~5h em 5 commits",
                 "nota":   "Desenho refeito 26/04: PDV vem antes da vistoria. Foco vira detectar vistoria órfã (receita perdida) + chip de status por lançamento. Faltam decisões em 6 edge cases — ver memória"},
                {"titulo": "Responsividade mobile — audit cirúrgico",
                 "status": "pendente", "estimativa": "~1-4h",
                 "nota":   "quando incomodar: pedir prints das telas no celular e corrigir só o que quebra. Caixa+Fechamento viram crítico se cair luz numa unidade"},
                {"titulo": "Integração Omie para envio do Fechamento",
                 "status": "pendente", "estimativa": "~7-10h",
                 "nota":   "Indianópolis + São Miguel já operam no Omie. OmieClient + roteador em api_send + tela de config (categoria/conta corrente descobertas via API). Gestão (Contas a Receber, Cobrança) continua só Tiny até ficar pressão real"},
