...
(function (global) {
  ...
  const ICONS = {
    ...
    save:        _svg('<path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"/><path d="M17 21v-8H7v8M7 3v5h8"/>'),
  ...
  const NAV_CATALOG = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "debug-vistorias-dia", label: "Debug Vistorias do Dia", icon: "wrench", href: "/master/debug-vistorias-dia", requires: "master" },
